    ...
    def test_compounded_principal(self):
    	"""
            ...
            the time expires.
    			...
    			t = number of years
                """
        self.assertEqual(compounded_principal(30), 100627, "The correct amount after 30 years should be 10626" )
    	...
    	self.assertEqual(compounded_principal(1.5), 11224, "The correct amount after 1.5 years should be 11223" )
